...
const char * udpAddress = "192.168.144.235"; //COMPUTER IP
...
uint16_t DataLenth[8] = {5,10,15,360,720,720,41,10};   //Dependiendo del tipo de paquete, éste contendrá cierta cantidad de datos
                                                //  -0 -> 5 datos     ->NA
                                                //  -1 -> 10 datos    ->NA
                                                //  -2 -> 15 datos    ->NA
